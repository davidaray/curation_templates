...
GENOME=<NAME>
RUNTYPE=${GENOME}_RM
DIR=/lustre/scratch/daray/bat1k_TE_analyses/te_curations/$GENOME/$RUNTYPE
LIBRARYPATH=/lustre/scratch/daray/bat1k_TE_analyses/te_curations/$GENOME/rmodeler_dir/${GENOME}-families.fa
GENOMEPATH=/lustre/scratch/daray/bat1k_TE_analyses/te_curations/$GENOME
